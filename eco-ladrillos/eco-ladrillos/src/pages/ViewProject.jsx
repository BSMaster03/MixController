    ...
    <div className="page">
      ...
      <div className="form-grid">
        ...
        <div className="field">
          ...
          <input value={project.wall_length} disabled />
        </div>

        <div className="field">
          <label>Altura del muro (m)</label>
          <input value={project.wall_height} disabled />
        </div>

        <div className="field">
          <label>Espesor del muro (m)</label>
          <input value={project.wall_thickness} disabled />
        </div>

        {/* Dimensiones del ladrillo */}
        <div className="field">
          <label>Longitud del ladrillo (m)</label>
          <input value={project.brick_length} disabled />
        </div>

        <div className="field">
          <label>Altura del ladrillo (m)</label>
          <input value={project.brick_height} disabled />
        </div>

        <div className="field">
          <label>Espesor del ladrillo (m)</label>
          <input value={project.brick_thickness} disabled />
        </div>

        {/* Mezcla */}
        <div className="field">
          <label>% PET</label>
          <input value={project.pet_percent} disabled />
        </div>

        <div className="field">
          <label>% Arena</label>
          <input value={project.sand_percent} disabled />
        </div>

        <div className="field">
          <label>% Cemento</label>
          <input value={project.cement_percent} disabled />
        </div>

        <div className="field">
          <label>% Agua</label>
          <input value={project.water_percent} disabled />
        </div>

        <div className="field">
          <label>Botellas por kg PET</label>
          <input value={project.bottles_per_kg_pet} disabled />
        </div>

        {/* Resultados */}
        <div className="field">
          <label>Total ladrillos</label>
          <input value={project.total_bricks} disabled />
        </div>

        <div className="field">
          <label>PET requerido (kg)</label>
          <input value={project.pet_kg} disabled />
        </div>

        <div className="field">
          <label>Botellas necesarias</label>
          <input value={project.bottles_needed} disabled />
        </div>
